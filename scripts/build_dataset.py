...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("equivxai.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from equivxai.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"equivxai.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/equivxai/data/__init__.py under BUILDERS, or use data=synthetic "
