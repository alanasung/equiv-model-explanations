...
from equivxai.configs.loader import register_schema
...
def _load_stage_registry(package: str = "equivxai") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in equivxai.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from equivxai.configs.loader import config_to_dict, save_resolved_config
    from equivxai.models.device import get_device
    from equivxai.utils.logging import configure_logging
    from equivxai.utils.reproducibility import set_seed
    from equivxai.utils.run_manifest import create_run_dir, save_run_metadata
