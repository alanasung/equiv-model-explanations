...
This note situates **Explanations That Survive Functionally Equivalent Models** against the motivating literature for
[Explanations That Survive Functionally Equivalent Models](https://github.com/alanasung/equiv-model-explanations).

## Positioning

Check whether component-level explanations remain stable across models trained to the same function.

The design hypothesis is: Check whether component-level explanations remain stable across models trained to the same function.
