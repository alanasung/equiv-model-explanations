"""Experiment stages for Explanations That Survive Functionally Equivalent Models."""
...
from .equivxai._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "Explanations That Survive Functionally Equivalent Models", "claims_gated": True},
    )
